...
class Create extends base\Main
{
    ...
    public function process(): void
    {
        ...
        try {
            ...
            $this->params['cms_project_user_bind_params'] = CmsUserRepository::setCmsProjectUserBind($this->params);
            ...
            $this->params['cms_group_params'] = CmsGroupRepository::create($this->params);
            $this->params['cms_project_group_bind_params'] = CmsGroupRepository::setCmsProjectGroupBind($this->params);
            ...
            $this->params['cms_group_params'] = CmsGroupRepository::create($this->params);
            $this->params['cms_project_group_bind_params'] = CmsGroupRepository::setCmsProjectGroupBind($this->params);
            $this->params['cms_group_user_bind_params'] = CmsGroupRepository::setCmsGroupUserBind($this->params);
            $transaction->commit();
        } catch (\Throwable $e) {
